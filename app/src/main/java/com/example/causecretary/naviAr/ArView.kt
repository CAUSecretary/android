...
import com.example.causecretary.naviAr.helper.SnackbarHelper
import com.example.causecretary.naviAr.helper.TapHelper
...
class ArView(val activity: ArActivity) : DefaultLifecycleObserver {
  val root = View.inflate(activity, R.layout.activity_arnavi, null)
